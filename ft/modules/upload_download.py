...
#
""" ft module which contains everything related to
...
from ft import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY
from ft.utils import edit_or_reply, humanbytes, man_cmd, progress, run_cmd
from ft.utils.FastTelethon import download_file, upload_file


@man_cmd(pattern="download(?: |$)(.*)")
async def download(target_file):
    """For .download command, download files to the ft's server."""
