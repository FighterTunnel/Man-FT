...
#
""" ft module for having some fun with people. """
...
from ft.utils import edit_delete, get_user_from_event
...
async def _(cowmsg):
    """For .cowsay module, ft wrapper for cow which says things."""
...
async def _(react):
    """Make your ft react to everything."""
...
CMD_HELP.update(
    {
        ...
        "\nUsage: UwU"
        f"\n\n>`{cmd}react`"
        "\nUsage: Buat ft Anda bereaksi terhadap semuanya."
        f"\n\n>`{cmd}slap`"
