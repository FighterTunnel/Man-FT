...
import ft.modules.sql_helper.gban_sql as gban_sql
from ft import BOTLOG_CHATID
from ft import CMD_HANDLER as cmd
from ft import CMD_HELP, DEVS, WHITELIST, blacklistman
from ft.events import register
from ft.utils import chataction, edit_or_reply, get_user_from_event, man_cmd
...
async def gban(event):
    ...
    if user.id in WHITELIST:
        await gbun.edit("**Gagal GBAN karena dia adalah admin @Sharingft 🗿**")
        return
