...
async def fban(event):
    ...
    try:
        from ft.modules.sql_helper.fban_sql import get_flist
    ...
    if event.sender_id == fban_id:
        return await event.edit(
            "**Error: Tindakan ini telah dicegah oleh protokol keamanan diri Man-ft.**"
        )
...
async def addf(event):
    ...
    try:
        from ft.modules.sql_helper.fban_sql import add_flist
    except IntegrityError:
        return await event.edit("**Running on Non-SQL mode!**")
...
async def delf(event):
    ...
    try:
        from ft.modules.sql_helper.fban_sql import del_flist
    except IntegrityError:
        return await event.edit("**Running on Non-SQL mode!**")
...
async def clearf(event):
    ...
    try:
        from ft.modules.sql_helper.fban_sql import del_flist_all
    except IntegrityError:
        return await event.edit("**Running on Non-SQL mode!**")
