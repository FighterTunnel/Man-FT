...
from ft import CMD_HELP, TEMP_DOWNLOAD_DIRECTORY, bot
from ft.utils import bash, deEmojify, man_cmd
...
async def FakeGoogleSearch(event):
    ...
    blue = (0, 0, 255)
    black = (0, 0, 0)
    font1 = ImageFont.truetype("ft/utils/styles/ProductSans-BoldItalic.ttf", 20)
    font2 = ImageFont.truetype("ft/utils/styles/ProductSans-Light.ttf", 23)
