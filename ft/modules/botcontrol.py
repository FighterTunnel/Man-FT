# Copyright (C) 2020 Catft <https://github.com/sandy1709/catft>
...
from ft.utils import _format, asst_cmd, callback, reply_id
    ...
    if chat.id != OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**👋 Hai** {mention}**!**\
                        ...
                        \n\n**Powered by** [Man-FT](https://github.com/FighterTunnel/Man-FT)"
        buttons = [
            (
