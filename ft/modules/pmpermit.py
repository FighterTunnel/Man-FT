...
#
""" ft module for keeping control who PM you. """
...
from ft import CMD_HELP, COUNT_PM, LASTMSG, LOGS, PM_AUTO_BAN, PM_LIMIT, bot
from ft.events import man_cmd
from ft.utils import edit_delete, edit_or_reply
...
async def permitpm(event):
    ...
    if (
        ...
        try:
            from ft.modules.sql_helper.globals import gvarstatus
            from ft.modules.sql_helper.pm_permit_sql import is_approved
...
async def auto_accept(event):
    ...
    if (
        ...
        try:
            from ft.modules.sql_helper.globals import gvarstatus
            from ft.modules.sql_helper.pm_permit_sql import approve, is_approved
        except AttributeError:
            return
...
async def notifoff(noff_event):
    try:
        from ft.modules.sql_helper.globals import addgvar
    except AttributeError:
...
async def notifon(non_event):
    try:
        from ft.modules.sql_helper.globals import delgvar
    except AttributeError:
...
async def approvepm(apprvpm):
    ...
    try:
        from ft.modules.sql_helper.globals import gvarstatus
        from ft.modules.sql_helper.pm_permit_sql import approve
    except AttributeError:
...
async def disapprovepm(disapprvpm):
    try:
        from ft.modules.sql_helper.pm_permit_sql import dissprove
    except BaseException:
...
async def add_pmsg(cust_msg):
    ...
    try:
        import ft.modules.sql_helper.globals as sql
    except AttributeError:
