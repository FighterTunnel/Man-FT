...
from ft.modules.sql_helper.globals import addgvar, delgvar, gvarstatus
...
CMD_HELP.update(
    {
        ...
        \n  •  **Function : **Tambahkan Variabel Baru Atau Memperbarui Variabel Setelah Menyetel Variabel Man-ft Akan Di Restart.\
...
CMD_HELP.update(
    {
        ...
        \n  •  **Function : **Tambahkan Variabel SQL Tanpa Merestart ft.\
