...
# button post makker for catft thanks to uniborg for the base
...
from ft import CMD_HELP, tgbot
from ft.utils import edit_delete, man_cmd, reply_id
...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}cbutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/channel_fightertunnell:same> [Support]<buttonurl:https://t.me/fightertunnell>`\
        ...
        \n  •  **Examples : **`{cmd}ibutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/channel_fightertunnell:same> [Support]<buttonurl:https://t.me/fightertunnell>`\
    "
    }
)
