...
""" ft module containing userid, chatid and log commands"""
...
from ft.modules.ping import absen
from ft.utils import edit_delete, edit_or_reply, get_user_from_event, man_cmd
...
# From Geez - Projects <https://github.com/vckyou/Geez-ft>
...
async def get_users(event):
    man_ = event.text[11:]
    chat_man = man_.lower()
    restricted = ["@Sharingft", "@sharingft"]
    ...
    manft = await get_chatinfo(event)
    ...
    async for user in event.client.iter_participants(manft.full_chat.id):
        try:
