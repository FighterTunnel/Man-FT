...
#
""" ft module for getting the date
    and time of any country or the ft server.  """
...
from ft import CMD_HELP, COUNTRY, TZ_NUMBER
...
async def time_func(tdata):
    ...
    2. The default ft country(set it by using .settime),
    3. The server where the ft runs.
    """
