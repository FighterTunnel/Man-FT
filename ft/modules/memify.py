...
from ft import CMD_HELP, TEMP_DOWNLOAD_DIRECTORY
from ft.utils import edit_delete, edit_or_reply, man_cmd, runcmd, take_screen_shot
...
async def add_text_img(image_path, text):
    ...
    font = ImageFont.truetype(
        font="ft/utils/styles/FontLord.ttf",
